...
@InputType()
class PredictionCreateNestedManyWithoutPlayersInput {
...
export { PredictionCreateNestedManyWithoutPlayersInput as PredictionCreateNestedManyWithoutPlayersInput };
