...
@InputType()
class PredictionCreateNestedManyWithoutMatchesInput {
...
export { PredictionCreateNestedManyWithoutMatchesInput as PredictionCreateNestedManyWithoutMatchesInput };
